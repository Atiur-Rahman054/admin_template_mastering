                    ...
                    <ul class="nav register_tabnav ul_li_center" role="tablist">
                        ...
                        <li role="presentation">
                            <button class="active" data-bs-toggle="tab" data-bs-target="#signup_tab" type="button"
                                role="tab" aria-controls="signup_tab" aria-selected="false"
                            ...
                            <form action="{{ route('login') }}" method="POST">
                                ...
                                <div class="form_item_wrap">
                                    ...
                                    <div class="form_item">
                                        ...
                                        <input id="username_input" type="email" placeholder="User Email"
                                ...
                                <div class="form_item_wrap">
                                    ...
                                    <div class="checkbox_item">
                                        ...
                                        <input class="form-check-input" type="checkbox" name="remember"
                                            id="remember_checkbox" {{ old('remember') ? 'checked' : '' }}>
                            ...
                            <form action="{{ route('register') }}" method="POST">
                                ...
                                <div class="form_item_wrap">
                                    ...
                                    <div class="form_item">
                                        ...
                                        <input id="username_input2" placeholder="User name" type="text"
                                ...
                                <div class="form_item_wrap">
                                    ...
                                    <div class="form_item">
                                        ...
                                        <input id="email_input" type="email" placeholder="User Email"
                                ...
                                <div class="form_item_wrap">
                                    ...
                                    <div class="form_item">
                                        ...
                                        <input id="password_input2" type="password" placeholder="Password"
                                ...
                                <div class="form_item_wrap">
                                    ...
                                    <div class="form_item">
                                        ...
                                        <input id="password_input3" type="password" placeholder="confirm password"
